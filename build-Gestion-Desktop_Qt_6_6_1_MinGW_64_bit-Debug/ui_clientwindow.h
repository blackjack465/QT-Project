...
"}"));
        ...
        recherche = new QPushButton(Commande);
        recherche->setObjectName("recherche");
        recherche->setGeometry(QRect(502, 20, 171, 29));
...
"}"));
    ...
    void retranslateUi(QMainWindow *ClientWindow)
    {
        ...
        recherche->setText(QCoreApplication::translate("ClientWindow", "Rechercher", nullptr));
